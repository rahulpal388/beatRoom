...
export function TrendingCards({ song, artist, image }: {
    ...
    return <>
        <div className=" dark:text-card dark:bg-accent-foreground/50 dark:hover:bg-accent-foreground  px-4 py-4  h-[15rem] rounded ">
            ...
            <p className=" text-xs dark:text-muted  ">{artist}</p>
        </div>
    </>
}